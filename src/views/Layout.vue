<template>
  <div class="container">
    <van-nav-bar v-if="active!=='/user'" fixed title="IT头条" right-text="搜索" @click-right="$router.push('/search')" />
...
export default {
  // data () {
  //   return {
  //     // van-tabbar-item name 的值
  //     active: this.$route.path  //当前路径
  //   }
  // }
  // 当去切换二级路由组件的时候 ，当前组件Layout是没有重新初始化的， data中的数据不会变化
